    ...
    <section className="py-20 relative overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="absolute left-8 top-0 w-px bg-gradient-to-b from-primary via-accent to-primary h-full"></div>
          ...
          <div className="space-y-12 pb-8">
            {experience.map((exp, index) => (
              ...
              >
                ...
                <div className="absolute left-7 top-8 w-4 h-4 bg-primary rounded-full border-4 border-background z-10 shadow-lg shadow-primary/30"></div>
